...
<div class="container-fluid" style="background-color: #333333;color: #ffffff;">
  ...
  <div class="col-md-4 text-center">
    <h3><b>Contact</b></h3>
      <hr style="height:2px;width:200px;border:none;color:#999999;background-color:#999999;">
      <p style="font-size:18px;font-family:consolas;color:#f2f2f2;"><span class="glyphicon glyphicon-map-marker" ></span> Noakhali</p><br>
...
<div class="text-center" id = "footer">&copy;Copyright 2018 Dailyneeds</div>
<!--Details Modal-->
<script >
